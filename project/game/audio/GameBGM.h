...
namespace GameBGM {
	...
	inline constexpr const char* kTitle = "resources/Audio/Morning.mp3";
	inline constexpr const char* kGameScene = "resources/Audio/Morning.mp3";
	inline constexpr const char* kBoss = "resources/Audio/Morning.mp3";
	inline constexpr const char* kGameClear = "resources/Audio/Morning.mp3";
	inline constexpr const char* kGameOver = "resources/Audio/Morning.mp3";
